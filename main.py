...
async def unlock_nude_callback(callback: CallbackQuery):
    ...
    base_prompt = (
        "Full-body, high-detail anime woman with a seductive, mature 'mommy' aura"
"She has a voluptuous hourglass figure with wide hips, thick thighs, and large soft breasts"
"Smooth soft skin with a gentle glow, anime-style shading and 2D rendering"
"She wears glossy lip balm and warm, flushed cheeks"
"Her face is stylized anime — large glossy eyes, small nose, soft lips, expressive blush"
"She has a confident but playful expression, giving a teasing seductive smile"
"She's wearing a sheer, revealing outfit — a transparent bikini-lingerie hybrid"
"The thin fabric softly reveals underboob, sideboob, and a teasing outline of her curves"
"Her thighs are thick and glistening, shown in a soft intimate pose"
"Her outfit gently clings to her waist and chest, leaving little to imagination"
"Her long anime hair flows past her shoulders, colored in natural or rich tones like brown or black"
"She stands in a cozy anime-style room with soft daylight and warm colors"
"Her pose is seductive but elegant, looking directly at the viewer with eye contact"
"Cel-shaded 2D anime art style, like WaifuLabs, NovelAI, or Blue Archive"
"High contrast, soft shadows, detailed linework, cute anime proportions"
"High resolution, full body, masterpiece level anime illustration"
"Tasteful NSFW, suggestive, no censorship, no nudity, anime proportions only"
    )
