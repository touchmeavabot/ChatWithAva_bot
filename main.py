...
if msg.text:
    ...
    elif "i feel" in text_lower or "i'm feeling" in text_lower:
        mood = full_message.split("i feel" if "i feel" in text_lower else "i'm feeling")[-1].strip().split('.')[0]
        memory["mood"] = mood

    elif "i want to confess" in text_lower:
