...
async def unlock_nude_callback(callback: CallbackQuery):
    ...
    base_prompt = (
        "Full-body, anime-style woman with a cute seductive cartoon face and thick curvy body"
"She has large golden amber anime eyes, long upper eyelashes, flushed cheeks, small soft lips"
"Her smile is confident, teasing, and playful, giving strong waifu girlfriend energy"
"Long flowing brown hair with a silky texture, reaching her waist, with soft shine"
"Her face is round and youthful, clearly anime-stylized with no realism"
"She has a voluptuous hourglass figure, huge perky anime-style breasts, slim waist, and wide hips"
"Thick juicy thighs with soft skin and a light glossy highlight, pressing together naturally"
"She wears a super tight turtleneck sweater dress that hugs her chest and waist"
"Outfit is thigh-length, slightly riding up to show upper thighs and soft skin"
"She has overknee black stockings squeezing into her thighs, adding plush effect"
"Her breasts are large and well-defined under the sweater, with visible bounce and shape"
"Waist curves inward softly, then flares out into wide, womanly hips"
"She’s sitting on a red leather couch near a window, with city background and daylight glow"
"Pose is cute and seductive — one hand on thigh, the other pointing to her cheek"
"Anime artstyle only, 2D cel shading, high contrast and soft light, clean outline art"
"Style similar to Blue Archive, WaifuLabs, or high-end NovelAI anime girls"
"High resolution, ultra-detailed, full-body illustration, no realism, pure anime"
"Tasteful NSFW tone, seductive but fully clothed, suggestive expression only"
    )
